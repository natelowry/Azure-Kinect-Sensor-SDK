...
FRAME_DIR_LIST = { "d:/git/Azure-Kinect-Sensor-SDK/doxygen/doxyrest-1.1.1-a-windows-amd64/frame/cfamily", "d:/git/Azure-Kinect-Sensor-SDK/doxygen/doxyrest-1.1.1-a-windows-amd64/frame/common"}
